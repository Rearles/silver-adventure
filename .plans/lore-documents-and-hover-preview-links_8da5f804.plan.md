...
- [ ] Create `frontend/src/app/components/lore-library/` — list (search/filter by org vs topic), article view, GM create/edit/delete/visibility-toggle form, all in a drawer/modal like `GmDossier`
